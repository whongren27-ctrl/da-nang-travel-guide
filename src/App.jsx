...
export default function App(){return <><Navbar/><Routes><Route path="/" element={<Home/>}/><Route path="/food" element={<PlaceListPage category="food"/>}/><Route path="/snacks" element={<PlaceListPage category="snacks"/>}/><Route path="/cafe" element={<PlaceListPage category="cafe"/>}/><Route path="/spa" element={<PlaceListPage category="spa"/>}/><Route path="/guide" element={<TravelInfoPage page="guide"/>}/><Route path="/spots" element={<TravelInfoPage page="spots"/>}/><Route path="/itinerary" element={<ItineraryPage/>}/><Route path="/tips" element={<TravelInfoPage page="tips"/>}/><Route path="/place/:slug" element={<PlaceDetailPage/>}/><Route path="*" element={<Placeholder/>}/></Routes></>}
